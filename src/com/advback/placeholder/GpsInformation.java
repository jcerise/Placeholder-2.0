...
public class GpsInformation extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		actionOne.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(GpsInformation.this, AppAction.class);
		...
		actionTwo.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(GpsInformation.this, Information.class);
		...
		infoText.setText("This is activity GPSInformation. This activity will"
				+ "contain direct output from the GPS, such as satellites, "
				+ "accuracy, current lat/lng etc...");
